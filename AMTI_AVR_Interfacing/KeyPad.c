...
{
	Dio_GroupSetDirection(KEYPAD_Rows_Port,KEYPAD_Rows_Mask,0xFF);// All Rows are Outputs
	Dio_GroupSetDirection(KEYPAD_Columns_Port,KEYPAD_Columns_Mask,0x00); // All Cols are inputs
	Dio_GroupPullupState(KEYPAD_Columns_Port,KEYPAD_Columns_Mask,0xFF);
